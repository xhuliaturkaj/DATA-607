...
# Week one - Xhulia Turkaj -  DATA 607 MSDS 
...
Visually speaking, the first thing I notice is that there seems to be a negative correlation between age group and the use of the deafult weather app on someone's phone to check the weather. Meaning younger age groups tend to use the deafult weather app more than older age groups. The opposite happens with using Local TV News, where older age gropus have significantly higher rates of using it to check the weather than younger age gropus. 
